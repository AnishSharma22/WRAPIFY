...
import { longTrackState } from '@/recoil/userState';
      ...
      <div className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <div className='limiter genre fader p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            <ul className='list-decimal pl-12 ml-0' style={{ maxWidth: '20rem', maxHeight: '30vh', position: 'relative'}}>
            <div className='mainImage'>
            <img
                ref={imageRef}
                src={longTrack[0].album.images[0].url}
                alt=""
          ...
          <div className='wrapper' style={{ marginTop: '1rem' }}>
            ...
            <a onClick={handleButtonClick} style={hasButtonBeenClicked ? filterStyle : {}}  ><img src={heartSVG} alt="Like" className='icons heart press icons w-6' style={{ minWidth: '1.5rem'}} /> </a>
              <div className='fader text-white' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '20rem' }}>
                <p style={{ fontSize: '1.3em', textAlign: 'center', width: '20rem' }}>{longTrack[0].name}</p>
                <p className='limiter' style={{ textAlign: 'center', fontSize: '0.8em', marginTop: '0.34em' }}>{longTrack[0].artists.map((artist, index) => (
                                          <span key={index}>
                                            {artist.name}
            ...
            <div className='grid fader justify-center items-center'>
              <input type="range" min="1" max="100" value="60" className='slider' style={{   background: 'linear-gradient(to right, #ffffff 2%, #B287D4 60%)', right: '0.9rem'}}/>

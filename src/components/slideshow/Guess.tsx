...
import { userState } from '@/recoil/userState';
  ...
  const Guess = () => {
    ...
    return (
      <div style={{background:"linear-gradient(180deg, #008D82 0%, #C54232 45%, #000000 100%)"}} className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <div className='limiter genre fader p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            <p style={{maxWidth: '30rem', position: 'relative', width: 'auto',left: '5rem', fontSize:'2rem', textAlign: 'center' ,height: '10rem', whiteSpace: 'wrap', lineHeight: '2.5rem'}}>Can you guess your all time most listened song?</p>
          ...
          <div className='wrapper' style={{ marginTop: '1rem' }}>
            ...
            <div className='grid fader justify-center items-center'>
              ...
              <input type="range" min="1" max="100" value="50" className='slider' style={{   background: 'linear-gradient(to right, #ffffff 2%, #B287D4 50%)', right: '0.9rem'}}/>
          ...
          <div className='flex justify-center items-center' >
            ...
            <a className='press' > <img className='icons' src={backPNG} style={{ height: '25px', marginRight: '3rem' }} alt="" /></a>
              ...
              <button className='press' onClick={()=>navigate('/eigth')}>

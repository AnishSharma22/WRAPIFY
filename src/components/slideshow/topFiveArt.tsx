  ...
  import ColorThief from 'colorthief';  import heartSVG from '../images/heart.png'
...
import { useNavigate } from 'react-router-dom';
import { useRecoilState } from 'recoil';
import { longArtistState, userState } from '@/recoil/userState';
      ...
      <div className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <div className=' genre p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            ...
            <div className='imagePlace' style={{ backgroundImage: `url(${longArtist[0].images[0].url})`, height:'4.2rem'}}>
            <img
                ref={imageRef}
                src={longArtist[2].images[0].url}
                alt=""
                crossOrigin="anonymous"
                style={{visibility:"hidden"}}
              />
               </div>
              <li>&nbsp;{longArtist[0].name}</li>
              {/* <p className='artist'>&nbsp; After Oceans</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${longArtist[1].images[0].url})`, top: '4.2rem'}}> </div>
              <li> &nbsp;{longArtist[1].name}</li>
              ...
              <div className='imagePlace' style={{ backgroundImage: `url(${longArtist[2].images[0].url})`, top: '7.7rem'}}> </div>
              <li>&nbsp;{longArtist[2].name}</li>
              {/* <p className='artist'>&nbsp; New Navy</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${longArtist[3].images[0].url})`, top: '11.2rem'}}> </div>
              <li>&nbsp;{longArtist[3].name}</li>
              {/* <p className='artist'>&nbsp; Drvmmer, Maelle</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${longArtist[4].images[0].url})`, top: '14.7rem'}}> </div>
              <li>&nbsp;{longArtist[4].name}</li>
          ...
          <div className='wrapper' style={{ marginTop: '1rem' }}>
            ...
            <a onClick={handleButtonClick} style={hasButtonBeenClicked ? filterStyle : {}}  ><img src={heartSVG} alt="Like" className='icons heart press icons w-6' style={{ minWidth: '1.5rem'}} /> </a>
              <div className='fader text-white' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '20rem' }}>
                <p style={{ fontSize: '1.3em', textAlign: 'center', width: '20rem' }}>Top 5 Artists of All Time!</p>
            ...
            <div className='grid fader justify-center items-center'>
              ...
              <input type="range" min="1" max="100" value="84" className='slider' style={{   background: 'linear-gradient(to right, #ffffff 2%, #B287D4 84%)', right: '0.9rem'}}/>
          ...
          <div className='flex justify-center items-start my-12 z-10'>
            ...
            <button className='press' onClick={()=>navigate('/tenth')}>

      ...
      <div style={{background:"linear-gradient(180deg, #D65DB1 0%, #202673 45%, #000000 100%)"}} className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <div className='limiter genre fader p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            <p style={{maxWidth: '30rem', position: 'relative', width: 'auto',left: '5rem', fontSize:'2rem', textAlign: 'center' ,height: '10rem', whiteSpace: 'wrap', lineHeight: '2.5rem'}}>What about your most streamed artist?</p>
          ...
          <div className='wrapper' style={{ marginTop: '1rem' }}>
            ...
            <div className='grid fader justify-center items-center'>
              ...
              <input type="range" min="1" max="100" value="69" className='slider' style={{   background: 'linear-gradient(to right, #ffffff 2%, #B287D4 69%)', right: '0.9rem'}}/>

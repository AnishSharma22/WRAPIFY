...
import { useNavigate } from 'react-router-dom';
import { useRecoilState } from 'recoil';
import {  shortArtistState, userState } from '@/recoil/userState';
  ...
  const TopFiveArtMonth = () => {
    ...
    const [shortArtist] = useRecoilState(shortArtistState);
        ...
        <div className='pager'>
          ...
          <div className=' genre p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            <ul className='limiter list-decimal pl-12 border-l-2 border-white ml-20' style={{ maxWidth: '20rem', maxHeight: '291px', position: 'relative', height:'291px'}}>
              <div className='imagePlace' style={{ backgroundImage: `url(${shortArtist[0].images[0].url})`, height:'4.2rem'}}>
              <img
                ref={imageRef}
                src={shortArtist[2].images[0].url}
                alt=""
                crossOrigin="anonymous"
                style={{visibility:"hidden"}}
              />
                 </div>
              <li>&nbsp;{shortArtist[0].name}</li>
              {/* <p className='artist'>&nbsp; After Oceans</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${shortArtist[1].images[0].url})`, top: '4.2rem'}}> </div>
              <li> &nbsp;{shortArtist[1].name}</li>
              ...
              <div className='imagePlace' style={{ backgroundImage: `url(${shortArtist[2].images[0].url})`, top: '7.7rem'}}> </div>
              <li>&nbsp;{shortArtist[2].name}</li>
              {/* <p className='artist'>&nbsp; New Navy</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${shortArtist[3].images[0].url})`, top: '11.2rem'}}> </div>
              <li>&nbsp;{shortArtist[3].name}</li>
              {/* <p className='artist'>&nbsp; Drvmmer, Maelle</p> */}
              <div className='imagePlace' style={{ backgroundImage: `url(${shortArtist[4].images[0].url})`, top: '14.7rem'}}> </div>
              <li>&nbsp;{shortArtist[4].name}</li>

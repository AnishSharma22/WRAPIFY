  ...
  import '../css/main.css';
import { useRecoilState } from 'recoil';
import { shortTrackState } from '@/recoil/userState';

// shortTrack[0].name  shortTrack[0].album.images[0].url shortTrack[0].artists[0].name
      ...
      <div className='super-div py-20'>
        ...
        <div className='pager'>
          ...
          <div className='limiter genre fader p-6 flex justify-center items-center text-white' style={{position: 'relative'}}>
            ...
            <img
                ref={imageRef}
                src={shortTrack[0].album.images[0].url}
                alt=""
          ...
          <div className='wrapper' style={{ marginTop: '1rem' }}>
            ...
            <a onClick={handleButtonClick} style={hasButtonBeenClicked ? filterStyle : {}}  ><img src={heartSVG} alt="Like" className='icons heart press icons w-6' style={{ minWidth: '1.5rem'}} /> </a>
              <div className='fader text-white' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '20rem' }}>
                <p style={{ fontSize: '1.3em', textAlign: 'center', width: '20rem' }}>{shortTrack[0].name}</p>
                <p className='limiter' style={{ textAlign: 'center', fontSize: '0.8em', marginTop: '0.34em' }}> {shortTrack[0].artists[0].name}</p>
              </div>
            ...
            <div className='grid fader justify-center items-center'>
              <input type="range" min="1" max="100" value="11" className='slider' style={{   background: 'linear-gradient(to right, #ffffff 2%, #B287D4 11%)', right: '0.9rem'}}/>
